...
function HBar({ label, pct, color, count }) {
  return (
...
function Section2({ result }) {
  const comps = [
    { key: 'd_opinion',   label: '관점편중도', weight: '35%',
      desc: '찬반 기사 솠림 정도 (높을수록 한 방향 기사 집중)' },
        ...
        return (
          <div key={cat} className={styles.catBiasRow}>
            ...
            <div className={styles.catBiasBarWrap}>
              <StackBar segments={[
                { pct: low  / total * 100, color: '#27ae60', label: '낙음' },
